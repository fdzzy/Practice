...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        secondaryGroupBox->setAutoFillBackground(false);
        secondaryGroupBox->setFlat(false);
        secondaryGroupBox->setCheckable(false);
        ...
        tertiaryGroupBox->setAutoFillBackground(false);
        tertiaryGroupBox->setFlat(false);
        tertiaryGroupBox->setCheckable(false);
